...
//                    }, label: {
//                        Text("\(viewStore.unitConversion.symbol)")
...
//                        }).buttonStyle(PlainButtonStyle())
//                        Spacer()
//                        Text("\(viewStore.coffeeAmount, specifier: "%.1f") \(viewStore.unitConversion.symbol)")
//                        Spacer()
//                        Button(action: {
...
//                        }).buttonStyle(PlainButtonStyle())
//                        Spacer()
//                        Text("\(viewStore.waterAmount, specifier: "%.0f") \(viewStore.unitConversion.symbol)")
//                        Spacer()
//                        Button(action: {
