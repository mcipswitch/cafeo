...
extension Color {
    ...
    public static let coffioHighlight = Color(#colorLiteral(red: 0.1607843137, green: 0.1725490196, blue: 0.1960784314, alpha: 1))
    public static let coffioShadowDark = Color(#colorLiteral(red: 0.2470588235, green: 0.262745098, blue: 0.2901960784, alpha: 1))
    public static let coffioShadowDarker = Color(#colorLiteral(red: 0.09411764706, green: 0.09803921569, blue: 0.1019607843, alpha: 1))
}
